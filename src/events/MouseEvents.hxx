...
struct MousePositionEvent
{
  ...
  int xVelocity;
  int yVelocity;
  [[deprecated("Use sdl::toMousePositionPosition instead")]]
...
struct ClickEvent
{
  ...
  uint8_t state;
  [[deprecated("Use sdl::toClickEvent instead")]]
...
struct ScrollEvent
{
  ...
  [[deprecated("Use sdl::toScrollEvent instead")]]
